DELIMITER $$
CREATE DEFINER=`intranet`@`%` PROCEDURE `materia_profesor` (IN periodoInicial CHAR(6)) (IN periodoFinal CHAR(6)) (IN periodoPrediccion CHAR(6)) (IN parcial INT(11)) (IN `materia` CHAR(6))
    READS SQL DATA
    DETERMINISTIC
